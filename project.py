...
#creating a google test id
CLIENT_ID = json.loads(
    open('client_secrets.json', 'r').read())['web']['client_id']
APPLICATION_NAME = "Technology Product Items"
...
#Making the connection to GCONNECT
...
def gconnect():
    ...
    # Verifying if the user is real or not
...
# Disconnecting a user's current token and reseting their login sessions
...
# JSON API TO LOOK INTO THE INFORMATION
...
# Main page with login credential requirements
@app.route('/')
@app.route('/catalog')
def showCatalog():
...
# Creating a new item in the process of CRUD
...
# Once Added show items inside the category
...
# Show the specific product item and the description
...
def editItem(categories_id, items_id):
    ...
    if editedItem.user_id != login_session['user_id']:
        return "<script>function myFunction() {alert('You are not authorized"\
         "to edit this item. Please add your own product item in order to edit.');"\
